...
# Read data
dataset = pd.read_csv('data/cleaning_vgsales.csv')
data = pd.DataFrame(dataset, columns=['Genre', 'Rating', 'Platform_General ', 'Normal_Global_Sale_Class'])
print(data)

# Set features
features = ['Genre', 'Rating', 'Platform_General']
# Set target feature column
target_col = 'Normal_Global_Sale_Class'
